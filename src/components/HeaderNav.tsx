      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="py-2 px-3.5 rounded-xl bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white font-bold text-xs transition shadow-[0_0_18px_rgba(16,185,129,0.3)] flex items-center gap-1.5 cursor-pointer active:scale-95"
            title="Post a round scorecard or update"
          >
